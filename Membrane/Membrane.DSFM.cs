...
namespace Membrane
{
    public abstract partial class Membrane
    {
        public class DSFM : Membrane
        {
            ...
            // Constructor
            public DSFM(Concrete.Biaxial concrete, Reinforcement.Biaxial reinforcement, double panelWidth, bool considerCrackSlip = true) : base(concrete,
                ...
                if (Concrete.Cracked)
                {
                    ...
                    finally
                    {
                        ...
                        if (solution)
                        {
                            ...
                            // Calculate vcimax
                            //double vcimax = MaximumShearOnCrack(Constants.PiOver2 - thetaC1, Concrete.PrincipalStrains.ec1);

                            //vci = Math.Min(vci, vcimax);
                        }
                        else
                            Console.WriteLine("Equilibrium on crack not reached.");
                    }
                }
